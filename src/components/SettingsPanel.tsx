...
export function SettingsPanel({ open, settings, saveState, onChange: applySettings, onUndo, onClose, onStartBackgroundEditing, fullscreenSupported, onFullscreenToggle, onResetSettings, onClearTimer, onMessage, adaptivePalette, customBackgrounds, onAddBackgrounds, onRemoveBackground, onReorderBackgrounds }: Props) {
  ...
  const clockBackgroundSetting = clockTarget ? settings.clockBackgroundSettings[clockTarget] ?? { position: defaultSettings.clockDatePosition, color: settings.clockColor, matchColors: settings.matchClockBackgroundColors } : { position: defaultSettings.clockDatePosition, color: settings.clockColor, matchColors: settings.matchClockBackgroundColors };
